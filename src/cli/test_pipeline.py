...
Usage:
    python -m src.cli.test_pipeline --parliament 44 --session 1 --limit 10
    python -m src.cli.test_pipeline --parliament 44 --no-enrich
    python -m src.cli.test_pipeline --help
"""
...
Examples:
  ...
  python -m src.cli.test_pipeline --parliament 44 --limit 20 --no-enrich

  # Fetch latest 5 bills from all parliaments and save to JSON
  python -m src.cli.test_pipeline --limit 5 --output results.json

  # Verbose logging
  python -m src.cli.test_pipeline --parliament 44 --limit 5 --verbose
        """
    )
