...
class BillRepository:
    ...
    def _domain_to_model(self, bill: Bill) -> BillModel:
        ...
        return BillModel(
            ...
            sponsor_politician_name=bill.sponsor_politician_name,
            introduced_date=bill.introduced_date,
            law_status=bill.law_status,
            legisinfo_id=bill.legisinfo_id,
            legisinfo_status=bill.legisinfo_status,
            legisinfo_summary_en=bill.legisinfo_summary_en,
            legisinfo_summary_fr=bill.legisinfo_summary_fr,
