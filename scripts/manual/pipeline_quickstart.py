"""Quick-start helper for running the bill pipeline.

Usage:
    python scripts/manual/pipeline_quickstart.py
"""
...
from src.orchestration.bill_pipeline import BillPipeline


async def main() -> None:
    """Run the quick-start pipeline helper."""
    print("\n" + "=" * 60)
